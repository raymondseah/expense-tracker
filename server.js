...
///////////////////////
// task creation
app.post("/api/v1/expense/create", expenseControllers.createExpense);
// product get
app.get("/api/v1/expense", verifyJWT, expenseControllers.getAllExpense);
// product delete
app.delete("/api/v1/expense/:id", expenseControllers.deleteExpenseById);
// update product
app.put("/api/v1/expense/:id", expenseControllers.updateExpenseById);
